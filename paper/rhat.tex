...
increasingly popular in statistics,
...
as in the online appendix. For each problem, we propose possible solutions 
...
hierarchical models. We can parameterize this simplemodel
...
away useful information also for convergence diagnostics. We run the eight
schools model with centered parameterization with $4\times 10^5$ iterations
per chain. We thin by 200, ending up with 4000 iterations as with the
default settings. {\bf I don't understand where 4000 comes from here.---AG}
...
\subsection*{A centered eight schools model fit using a Gibbs sampler}\label{eight-schools-with-jags}}
