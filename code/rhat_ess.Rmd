...
behavior of $\widehat{R}$ and $S_{\rm eff}$ do not change from the
ones presented in [Section *Split*-$\widehat{R}$](#SplitRhat) for
normally distributed $\theta$.
...
## Efficiency estimates for quantiles and tail-ESS {#quantile_S_eff}
...
parameterization of theeight schools model much better than from the centered parameterization.
