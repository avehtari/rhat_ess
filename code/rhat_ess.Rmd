...
available on Github (https://github.com/avehtari/rhat_ess). Here, we provide all the
...
Several values of Rhat greater than 1.01 and some ESS less than 400 also indicate convergence propblems. The [Appendix C](#AppendixC) contains more results
with longer chains.
...
Similar as above, we see that the efficiency of sampling is low in the tails. Orange ticks show iterations that exceeded the maximum
treedepth.
...
with this alternative parameterization. [Appendix C](#AppendixC) has
...
bulk-ESS and tail-ESS are consistently low. See [Appendix D](#AppendixD) for
