...
omnipresent in Bayesian statistics in the form of Markov-Chain Monto-Carlo
...
indicating problemes for estimating the scale of the posterior.
...
tail-ESS's are small indicating problmes for estimating the
...
**Result:** Rank normalized S_eff's have less variation than classic 
...
bulk-ESS and median-ESS, the efficency for central
quantities is much lower, but based on tail-ESS and
MAD-ESS, the efficency in the tails is slightly better than for
