...
tail-ESS is `r round(min(res$zsseff), 2)` indicating problems for estimating the
...
As the efficiency for estimating small `tau` values is very close to 0, we may
...
many of the are very close to 0 indicates clear failure in mixing. The rank
