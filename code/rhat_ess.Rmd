---
title: "Rank-normalization, folding, and localization: A version of $\\widehat{R}$ that successfully assesses the convergence of iterative simulation algorithms (online appendix)"
...
*Rank-normalization, folding, and localization: A version of* $\widehat{R}$
*that successfully assesses the convergence of iterative simulation algorithms* 
available on Github (https://github.com/avehtari/rhat). Here, we provide all the
compute code related to the examples presented in the paper and more numerical
experiments not discussed in the paper itself.
...
- [Appendix A: Computing the effective sample size](#AppendixA)
- [Appendix B: Normal distributions with additional trend, shift or scaling](#AppendixB)
- [Appendix C: More experiments with the Cauchy distribution](#AppendixC)
- [Appendix D: A centered eight schools model with very long chains and thinning](#AppendixD)
- [Appendix E: A centered eight schools model fit using a Gibbs sampler](#AppendixE)
...
in determining convergence. [Appendices B-E](#AppendixB) contain more
...
[Appendix C](#AppendixC) contains more detailed analysis of different algorithm
...
should not be trusted. The [Appendix C](#AppendixC) has more results
...
with the alternative parameterization. [Appendix C](#AppendixC) has
...
[Appendix D](#AppendixD) contains more detailed analysis of different algorithm variants.
...
See [Appendix D](#AppendixD) for results of longer chains.
...
bulk-ESS and tail-ESS are too low. See [Appendix D](#AppendixD) for
...
## Appendix A: Computing the effective sample size {#AppendixA .unnumbered}

There are no examples or numerical experiments related to Appendix A.

 
## Appendix B: Normal distributions with additional trend, shift or scaling {#AppendixB .unnumbered}
...
## Appendix C: More experiments with the Cauchy distribution {#AppendixC .unnumbered}
...
## Appendix D: A centered eight schools model with very long chains and thinning {#AppendixD .unnumbered}
...
## Appendix E: A centered eight schools model fit using a Gibbs sampler {#AppendixE .unnumbered}
