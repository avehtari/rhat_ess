...
in the paper (the names correspond to the section headers used in the paper):

- [Cauchy: A distribution with infinite mean and variance](#cauchy)
- [Hierarchical model: Eight schools](#eightschools)
- [Appendix B: Normal distributions with additional trend, shift or scaling](#AppendixD)
- [Appendix C: More experiments with the Cauchy distribution](#AppendixE)
- [Appendix D: A centered eight schools model with very long chains and thinning](#AppendixF)
- [Appendix E: A centered eight schools model fit using a Gibbs sampler](#eightschoolsJAGS)
...
### Eight Schools with Jags {#eightschoolsJAGS .unnumbered}
