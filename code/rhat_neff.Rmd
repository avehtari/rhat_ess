...
simulations. The effective sample size estimate ($N_{\mbox{eff}}$) by 
...
Classic $N_{\mbox{eff}}$ focuses on posterior mean, but as the mean 
...
The proposal is to switch in Stan
 ...
 rank-normalized-split-$R_{\mbox{eff}}$ (zsreff) and 
 folded-rank-normalized-split-$R_{\mbox{eff}}$ (fzsreff)
 - if computing median and MAD_SD, report corresponding 
 $R_{\mbox{eff}}$'s (medsreff and madsreff)
