...
implied that $\hat{N}_{\rm eff}$ was capped at $N$. As
...
We can't write this down as a simple expectation, but we can represent it by
...
to squeeze to a mess in case of long chains. Whithin this case study,
we will illustrate the use and interpreation of rank plots.
...
rank-normalized efficiency and Monte Carlo error estimates 
for the desired quantities, as the latter is only applicable when mean 
and variance of this quantity exist. We
